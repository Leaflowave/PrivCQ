...
def adult_main_exp1(delta,budget,repeatTimes):
    ...
    framework(S,groupDict,sequence,budget,len(sequence),delta,"experiments//adult_1_OLH_results.txt",[0],randomiser="OLH")
    end = time.time()
    print(end-start)
    return
...
def adult_main_exp2(delta,budget,repeatTimes):
    ...
    framework(S, groupDict, sequence, budget, len(sequence), delta, "experiments//adult_2_OLH_results.txt", [0,1],randomiser="OLH")
    end = time.time()
    print(end - start)
    return
...
def adult_main_exp3(delta,budget,repeatTimes):
    ...
    framework(S, None, sequence, budget, len(sequence), delta, "experiments//adult_3_OLH_results.txt", [0, 1,2],randomiser="OLH")
    end = time.time()
    print(end - start)
    return
...
def adult_main_exp4(delta,budget,repeatTimes):
    ...
    framework(S, None, sequence, budget, len(sequence), delta, "experiments//adult_4_OLH_results.txt", [0, 2],randomiser="OLH")
    end = time.time()
    print(end - start)
    return

...
def adult_main_exp1(delta,budget,repeatTimes):
    ...
    framework(S,groupDict,sequence,budget,len(sequence),delta,"experiments//adult_1_gr_OLHnew_results.txt",[0],randomiser="OLHnew",auctionMethod="GR")
    end = time.time()
    print(end-start)
    return
...
def adult_main_exp2(delta,budget,repeatTimes):
    ...
    framework(S, groupDict, sequence, budget, len(sequence), delta, "experiments//adult_2_gr_OLHnew_results.txt", [0,1],randomiser="OLHnew",auctionMethod="GR")
    end = time.time()
    print(end - start)
    return
...
def adult_main_exp3(delta,budget,repeatTimes):
    ...
    framework(S, None, sequence, budget, len(sequence), delta, "experiments//adult_3_gr_OLHnew_results.txt", [0, 1,2],randomiser="OLHnew",auctionMethod="GR")
    end = time.time()
    print(end - start)
    return
...
def adult_main_exp4(delta,budget,repeatTimes):
    ...
    framework(S, None, sequence, budget, len(sequence), delta, "experiments//adult_4_gr_OLHnew_results.txt", [0,2],randomiser="OLHnew",auctionMethod="GR")
    end = time.time()
    print(end - start)
    return

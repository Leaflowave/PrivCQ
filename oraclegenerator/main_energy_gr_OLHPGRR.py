...
def energy_main_exp1(delta,budget,repeatTimes):
    ...
    framework(S,groupDict,sequence,budget,len(sequence),delta,"experiments//energy_1_gr_OLHPGRR_results.txt",[0],randomiser="OLHPGRR",auctionMethod="GR")
    end = time.time()
    print(end-start)
    return
...
def energy_main_exp2(delta,budget,repeatTimes):
    ...
    framework(S, groupDict, sequence, budget, len(sequence), delta, "experiments//energy_2_gr_OLHPGRR_results.txt", [0,1],randomiser="OLHPGRR",auctionMethod="GR")
    end = time.time()
    print(end - start)
    return
...
def energy_main_exp3(delta,budget,repeatTimes):
    ...
    framework(S, None, sequence, budget, len(sequence), delta, "experiments//energy_3_gr_OLHPGRR_results.txt", [0, 1,2],randomiser="OLHPGRR",auctionMethod="GR")
    end = time.time()
    print(end - start)
    return
...
def energy_main_exp4(delta,budget,repeatTimes):
    ...
    framework(S, None, sequence, budget, len(sequence), delta, "experiments//energy_4_gr_OLHPGRR_results.txt", [0, 2],randomiser="OLHPGRR",auctionMethod="GR")
    end = time.time()
    print(end - start)
    return

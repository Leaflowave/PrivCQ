    ...
    for i in range(1,501):
        for _ in range(10):
            ...
            if aggregation=="count":
                ...
                count_value=(count_value/49734)*n
...
if __name__ == '__main__':
    tablePath="experiments//movie_1_gr_PGRR_results.txt"
    tableInterval=13
...
##    file_1 = open("experiments//movie_1_gr_PGRR_results.txt", "r")
##    a = file_1.readline()
##    print(a)
    ...
    print(relativeError)
    with open("experiments//final_movie_1_count_gr_PGRR.txt","w+") as f:
        f.write(str(ans)+"\n")
    ...
    print(relativeError)
    with open("experiments//final_movie_1_sum_gr_PGRR.txt","w+") as f:
        f.write(str(ans)+"\n")
        f.write("true ans" + str(trueAns) + "\n")
        f.write("relativeError:"+str(relativeError)+"\n")
        f.write("averageError:"+str(averageError)+"\n")

...
if __name__ == '__main__':
    oraclePath = "experiments//adult_3_gr_PGRR_results.txt"
    oracleInterval = 4
    queryPath = "experiments//adult_query_5_7_9.txt"
    trueOraclePath = "adult//adult5.txt"


    # file_1 = open("experiments//adult_3_gr_PGRR_results.txt", "r")
    # a = file_1.readline()
    # print(a)
    ...
    ans, trueans,relativeError, averageError = query_on_adult_dim2(oraclePath, oracleInterval,
                                                           ...
                                                           aggregation="sum")
    print(relativeError)
    with open("experiments//final_adult_3_sum_gr_PGRR.txt", "w+") as f:
        f.write(str(ans) + "\n")
        f.write(str(trueans)+"\n")

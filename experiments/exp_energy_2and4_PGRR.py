    ...
    for i in range(1,501):
        for _ in range(10):
            ...
            if aggregation=="count":
                ...
                count_value=(count_value/7296)*n
...
if __name__ == '__main__':
    tablePath="experiments//energy_1_PGRR_results.txt"
    tableInterval=125
    ...
    print(relativeError)
    with open("experiments//final_energy_1_count_PGRR.txt","w+") as f:
        f.write(str(ans)+"\n")
    ...
    print(relativeError)
    with open("experiments//final_energy_1_sum_PGRR.txt","w+") as f:
        f.write(str(ans)+"\n")
        f.write("true ans" + str(trueAns) + "\n")
        f.write("relativeError:"+str(relativeError)+"\n")
        f.write("averageError:"+str(averageError)+"\n")

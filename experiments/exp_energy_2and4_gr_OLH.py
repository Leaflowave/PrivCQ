...
if __name__ == '__main__':
    oraclePath="experiments//energy_1_gr_OLH_results.txt"
    ...
    print(relativeError)
    with open("experiments//final_energy_1_count_gr_OLH.txt","w+") as f:
        f.write(str(ans)+"\n")
    ...
    print(relativeError)
    with open("experiments//final_energy_1_sum_gr_OLH.txt","w+") as f:
        f.write(str(ans)+"\n")
        f.write("true ans" + str(trueAns) + "\n")
        f.write("relativeError:"+str(relativeError)+"\n")
        f.write("averageError:"+str(averageError)+"\n")

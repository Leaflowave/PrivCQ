    ...
    for i in range(1,501):
        for _ in range(10):
            ...
            if aggregation=="count":
                ...
                count_value=(count_value/7820)*n
...
if __name__ == '__main__':
    oraclePath = "experiments//energy_2_PGRR_results.txt"
    oracleInterval = 125
    ...
    ans,trueans, relativeError, averageError = query_on_adult_dim2(oraclePath, oracleInterval,
                                                           ...
                                                           trueOraclePath,
                                                       aggregation="count")
    file_1 = open("experiments//energy_2_PGRR_results.txt", "r")
    a = file_1.readline()
    print(a)

    print(relativeError)
    with open("experiments//final_energy_2_count_range_PGRR.txt", "w+") as f:
        f.write(str(ans) + "\n")
    ...
    ans,trueans, relativeError, averageError = query_on_adult_dim2(oraclePath, oracleInterval,
                                                           ...
                                                           aggregation="sum")
    print(relativeError)
    with open("experiments//final_energy_2_sum_range_PGRR.txt", "w+") as f:
        f.write(str(ans) + "\n")
        f.write("true ans" + str(trueans) + "\n")
        f.write("relativeError:" + str(relativeError) + "\n")
        f.write("averageError:" + str(averageError) + "\n")

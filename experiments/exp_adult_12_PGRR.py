...
if __name__ == '__main__':
    oraclePath = "experiments//adult_4_PGRR_results.txt"
    oracleInterval = 4
    queryPath = "experiments//adult_query_2_4_12.txt"
    trueOraclePath = "adult//adult6.txt"

    # file_1 = open("experiments//adult_3_PGRR_results.txt", "r")
    # a = file_1.readline()
    # print(a)
    ...
    ans,trueans, relativeError, averageError = query_on_adult_dim3(oraclePath, oracleInterval,
                                                           ...
                                                           aggregation="sum")
    print(relativeError)
    with open("experiments//final_adult_12_PGRR.txt", "w+") as f:
        f.write(str(ans) + "\n")

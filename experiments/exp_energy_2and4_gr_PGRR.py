...
if __name__ == '__main__':
    tablePath="experiments//energy_1_gr_PGRR_results.txt"
    tableInterval=129
    queryPath="experiments//energy_query_2_4.txt"
    trueOraclePath="energy//energy4.txt"

    # file_1 = open("experiments//energy_1_PGRR_results.txt", "r")
    # a = file_1.readline()
    # print(a)
    ...
    print(relativeError)
    with open("experiments//final_energy_1_count_gr_PGRR.txt","w+") as f:
        f.write(str(ans)+"\n")
    ...
    print(relativeError)
    with open("experiments//final_energy_1_sum_gr_PGRR.txt","w+") as f:
        f.write(str(ans)+"\n")
        f.write("true ans" + str(trueAns) + "\n")
        f.write("relativeError:"+str(relativeError)+"\n")
        f.write("averageError:"+str(averageError)+"\n")

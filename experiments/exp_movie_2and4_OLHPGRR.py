...
if __name__ == '__main__':
    oraclePath="experiments//movie_1_OLHPGRR_results.txt"
    ...
    print(relativeError)
    with open("experiments//final_movie_1_count_OLHPGRR.txt","w+") as f:
        f.write(str(ans)+"\n")
    ...
    print(relativeError)
    with open("experiments//final_movie_1_sum_OLHPGRR.txt","w+") as f:
        f.write(str(ans)+"\n")
        f.write("true ans" + str(trueAns) + "\n")
        f.write("relativeError:"+str(relativeError)+"\n")
        f.write("averageError:"+str(averageError)+"\n")

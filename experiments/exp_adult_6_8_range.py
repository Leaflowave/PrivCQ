...
if __name__ == '__main__':
    ...
    #                                                        aggregation="sum")
    # print(relativeError)
    # with open("experiments//final_adult_2_sum_range.txt", "w+") as f:
    #     f.write(str(ans) + "\n")
    #     f.write("true ans" + str(trueans) + "\n")
    #     f.write("relativeError:" + str(relativeError) + "\n")
    #     f.write("averageError:" + str(averageError) + "\n")

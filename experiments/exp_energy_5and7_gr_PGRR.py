    ...
    for i in range(1,501):
        for _ in range(10):
            ...
            if aggregation=="count":
                ...
                count_value=(count_value/12081)*n
...
if __name__ == '__main__':
    ...
    ans, Trueans,relativeError, averageError = query_on_adult_dim2(oraclePath, oracleInterval,
                                                           ...
                                                           aggregation="count")
    print(relativeError)
    with open("experiments//final_energy_2_count_gr_PGRR.txt", "w+") as f:
        f.write(str(ans) + "\n")
    ...
    ans, Trueans,relativeError, averageError = query_on_adult_dim2(oraclePath, oracleInterval,
                                                           ...
                                                           aggregation="sum")
    print(relativeError)
    with open("experiments//final_energy_2_sum_gr_PGRR.txt", "w+") as f:
        f.write(str(ans) + "\n")
        f.write("true ans" + str(Trueans) + "\n")
        f.write("relativeError:" + str(relativeError) + "\n")
        f.write("averageError:" + str(averageError) + "\n")

...
if __name__ == '__main__':
    oraclePath = "experiments//movie_3_PGRR_results.txt"
    oracleInterval = 4
    queryPath = "experiments//movie_query_6_8_10.txt"
    trueOraclePath = "movie//movie5.txt"

    # file_1 = open("experiments//movie_3_PGRR_results.txt", "r")
    # a = file_1.readline()
    # print(a)
    ...
    ans,trueans, relativeError, averageError = query_on_adult_dim3(oraclePath, oracleInterval,
                                                           ...
                                                           aggregation="sum")
    print(relativeError)
    with open("experiments//final_movie_3_sum_range_PGRR.txt", "w+") as f:
        f.write(str(ans) + "\n")

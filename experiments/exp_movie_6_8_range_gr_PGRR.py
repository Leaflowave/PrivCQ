    ...
    for i in range(1,501):
        for _ in range(10):
            ...
            if aggregation=="count":
                ...
                count_value=(count_value/49997)*n
...
if __name__ == '__main__':
    oraclePath = "experiments//movie_2_gr_PGRR_results.txt"
    oracleInterval = 13
    queryPath = "experiments//movie_query_6_8_10.txt"
    trueOraclePath = "movie//movie5.txt"

    # file_1 = open("experiments//movie_2_gr_PGRR_results.txt", "r")
    # a = file_1.readline()
    # print(a)
    ...
    print(relativeError)
    with open("experiments//final_movie_2_count_range_gr_PGRR.txt", "w+") as f:
        f.write(str(ans) + "\n")
    ...
    ans,trueans, relativeError, averageError = query_on_adult_dim2(oraclePath, oracleInterval,
                                                           ...
                                                           aggregation="sum")
    print(relativeError)
    with open("experiments//final_movie_2_sum_range_gr_PGRR.txt", "w+") as f:
        f.write(str(ans) + "\n")
        f.write("true ans" + str(trueans) + "\n")
        f.write("relativeError:" + str(relativeError) + "\n")
        f.write("averageError:" + str(averageError) + "\n")

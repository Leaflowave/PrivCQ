...
if __name__ == '__main__':
    oraclePath = "experiments//movie_2_OLH_results.txt"
    oracleInterval = 18
    ...
    ans,trueans, relativeError, averageError = query_on_adult_dim2(oraclePath, oracleInterval,
                                                           ...
                                                           aggregation="count")
    print(relativeError)
    with open("experiments//final_movie_2_count_range_OLH.txt", "w+") as f:
        f.write(str(ans) + "\n")
    ...
    ans,trueans, relativeError, averageError = query_on_adult_dim2(oraclePath, oracleInterval,
                                                           ...
                                                           aggregation="sum")
    print(relativeError)
    with open("experiments//final_movie_2_sum_range_OLH.txt", "w+") as f:
        f.write(str(ans) + "\n")
        f.write("true ans" + str(trueans) + "\n")
        f.write("relativeError:" + str(relativeError) + "\n")
        f.write("averageError:" + str(averageError) + "\n")

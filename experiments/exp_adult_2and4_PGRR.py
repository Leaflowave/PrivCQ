    ...
    for i in range(1,501):
        for _ in range(10):
            ...
            if aggregation=="count":
                ...
                count_value=(count_value/19572)*n
...
if __name__ == '__main__':
    tablePath="experiments//adult_1_PGRR_results.txt"
    tableInterval=23
    queryPath="experiments//adult_query_2_4_12.txt"
    trueOraclePath="adult//adult4.txt"

    # file_1 = open("experiments//adult_1_PGRR_results.txt", "r")
    # a = file_1.readline()
    # print(a)
    ...
    print(relativeError)
    with open("experiments//final_adult_1_count_PGRR.txt","w+") as f:
        f.write(str(ans)+"\n")
    ...
    print(relativeError)
    with open("experiments//final_adult_1_sum_PGRR.txt","w+") as f:
        f.write(str(ans)+"\n")
        f.write("true ans" + str(trueAns) + "\n")
        f.write("relativeError:"+str(relativeError)+"\n")
        f.write("averageError:"+str(averageError)+"\n")
